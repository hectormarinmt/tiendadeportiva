    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProduct1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("description", getString(R.string.text_descripcion_balon));
                intent.putExtra("imageCode",R.drawable.balon);
        ...
        btnProduct2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("description", getString(R.string.text_descripcion_balon_2018));
                intent.putExtra("imageCode",R.drawable.balon2018);
                startActivity(intent);
            }
        });
        ...
        btnProduct3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("description", getString(R.string.text_descripcion_balon_2014));
                intent.putExtra("imageCode",R.drawable.balon2014);
                startActivity(intent);
            }
        });
